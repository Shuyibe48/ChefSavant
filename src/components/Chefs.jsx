...
const Chefs = () => {
    const chefs = [
        {
            id: 1,
            image: 'https://images.unsplash.com/photo-1583394293214-28ded15ee548?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=580&q=80',
            name: 'John Doe',
            experience: 10,
            recipes: 50,
            likes: 100,
    ...
    return (
        <div className="container px-4 lg:px-0 mx-auto py-8">
            <h2 className="text-2xl font-bold mb-8">Top Chefs</h2>
