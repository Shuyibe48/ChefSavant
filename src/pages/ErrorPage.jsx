...
const ErrorPage = () => {
  return (
    <div className="py-12 flex flex-col h-full items-center justify-center bg-gray-200">
      <img src="https://i.redd.it/di3tv7rh2h311.jpg" alt="Error" className="w-64 h-auto mb-8" />
